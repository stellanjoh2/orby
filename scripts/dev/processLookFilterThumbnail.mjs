...
/**
 * Center-crop to square, resize, and write a compressed look-filter PNG thumbnail.
 * @param {{
 *   pngBuffer: Buffer,
 *   preset: string,
 *   size?: number,
 ...
 * }} opts
 */
export async function processLookFilterThumbnail({
  pngBuffer,
  preset,
  size = 192,
  outDir,
  ...
  return {
    ...
    thumbSize,
    relativePath: `assets/images/look-filters/${filename}`,
