...
class CreativeLookSketchPass extends Pass {
  ...
  constructor(renderer) {
    ...
    this._compositeMat = new THREE.ShaderMaterial({
      ...
      fragmentShader: SKETCH_COMPOSITE_FRAGMENT,
      depthTest: false,
      depthWrite: false,
    });
...
/** High-contrast pencil illustration — toon shadow bands + ink outline post pass. */
export class CreativeLookSketch {
  /** @param {import('three').WebGLRenderer} renderer */
  constructor(renderer) {
    this.pass = new CreativeLookSketchPass(renderer);
  }
