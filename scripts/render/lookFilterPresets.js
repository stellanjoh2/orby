 ...
 * Chromatic aberration: `aberration` merges with defaults; set `enabled: false` for none. When on, `amount` is the radial channel-separation magnitude (0..0.02 typical); `blur` adds radial streak smear (0..1); `falloff` controls edge spread toward center (0.5..3, higher = more dispersed); `quality` sets blur sample count (low..ultra).
 */
const PRESET_SPECS = {
  studio: {
